...
import (
	...
	"github.com/ammm56/lings/util/bech32"
)
...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "mainnet p2pk",
			addr:    "lings:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35cdv0dy335",
		...
		{
			name:    "mainnet p2pk 2",
			addr:    "lings:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
		...
		{
			name:    "testnet p2pk",
			addr:    "lingstest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35ckquw528z",
		...
		// ECDSA P2PK tests.
		{
			...
			addr:    "lings:qyp0r5mcq4rd5grj3652ra09u5dcgwqq9ntuswp247nama5quyj40eq03sc2dkx",
		...
		{
			name:    "mainnet p2sh",
			addr:    "lings:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
		...
		{
			name:    "mainnet p2sh 2",
			addr:    "lings:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
		...
		{
			name:    "testnet p2sh",
			addr:    "lingstest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx35yyy2h9",
