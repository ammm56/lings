...
// MsgRequestHeaders implements the Message interface and represents a lings
...
// NewMsgRequstHeaders returns a new lings RequestHeaders message that conforms to the
