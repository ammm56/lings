...
// MsgTransactionNotFound defines a lings TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new lings transactionsnotfound message that conforms to the
