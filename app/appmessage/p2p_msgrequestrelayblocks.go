...
// MsgRequestRelayBlocks implements the Message interface and represents a lings
...
// NewMsgRequestRelayBlocks returns a new lings RequestRelayBlocks message that conforms to
