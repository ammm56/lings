...
// MsgRequestAnticone implements the Message interface and represents a lings
...
// NewMsgRequestAnticone returns a new lings RequestPastDiff message that conforms to the
