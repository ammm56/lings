...
// MsgRequestNextPruningPointAndItsAnticoneBlocks implements the Message interface and represents a lings
...
// NewMsgRequestNextPruningPointAndItsAnticoneBlocks returns a new lings RequestNextPruningPointAndItsAnticoneBlocks message that conforms to the
// Message interface.
