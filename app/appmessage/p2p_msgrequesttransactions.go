...
// MsgRequestTransactions implements the Message interface and represents a lings
...
// NewMsgRequestTransactions returns a new lings RequestTransactions message that conforms to
