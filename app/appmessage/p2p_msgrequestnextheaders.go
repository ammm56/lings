...
// MsgRequestNextHeaders implements the Message interface and represents a lings
...
// NewMsgRequestNextHeaders returns a new lings RequestNextHeaders message that conforms to the
// Message interface.
