...
// RPCTransaction is a lings transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a lings transaction input representation
...
// RPCScriptPublicKey is a lings ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a lings transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a lings outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a lings utxo entry representation meant to be used
// over RPC
