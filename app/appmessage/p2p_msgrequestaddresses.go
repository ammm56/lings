...
// MsgRequestAddresses implements the Message interface and represents a lings
...
// NewMsgRequestAddresses returns a new lings RequestAddresses message that conforms to the
