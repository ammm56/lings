...
// lings Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a lings
// Addresses message.
...
// NewMsgAddresses returns a new lings Addresses message that conforms to the
