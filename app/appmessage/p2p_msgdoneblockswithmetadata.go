...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a lings
...
// NewMsgDoneBlocksWithTrustedData returns a new lings DoneBlocksWithTrustedData message that conforms to the
// Message interface.
