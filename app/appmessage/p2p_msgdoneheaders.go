...
// MsgDoneHeaders implements the Message interface and represents a lings
...
// NewMsgDoneHeaders returns a new lings DoneIBDBlocks message that conforms to the
// Message interface.
