...
// MsgIBDChainBlockLocator implements the Message interface and represents a lings
...
// NewMsgIBDChainBlockLocator returns a new lings locator message that conforms to
