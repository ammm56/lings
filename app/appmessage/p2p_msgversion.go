...
import (
	...
	"github.com/ammm56/lings/util/mstime"
)
...
var DefaultUserAgent = fmt.Sprintf("/lings:%s/", version.Version())

// MsgVersion implements the Message interface and represents a lings version
...
// NewMsgVersion returns a new lings version message that conforms to the
