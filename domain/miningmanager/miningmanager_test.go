...
import (
	...
	"github.com/ammm56/lings/domain/consensusreference"
	"github.com/ammm56/lings/domain/miningmanager/model"
	...
	"github.com/ammm56/lings/domain/consensus/utils/transactionhelper"
	"github.com/ammm56/lings/domain/consensus/utils/txscript"
	"github.com/ammm56/lings/domain/consensus/utils/utxo"
	"github.com/ammm56/lings/domain/miningmanager"
...
func generateNewCoinbase(addressPrefix util.Bech32Prefix, op opType) (*externalapi.DomainCoinbaseData, error) {
	...
	_, publicKey, err := liblingswallet.CreateKeyPair(op == opECDSA)
	if err != nil {
		return nil, err
	}
	var address string
