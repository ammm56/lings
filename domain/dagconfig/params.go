...
type Params struct {
	...
	// Further details: https://hashdag.medium.com/lings-launch-plan-9a63f4d754a6
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: https://github.com/lingsnet/research/issues/3
