...
import (
	...
	"github.com/ammm56/lings/domain/consensus/utils/serialization"
	...
	"github.com/ammm56/lings/util/binaryserializer"
...
// writeTransactionInput encodes ti to the lings protocol encoding for a transaction
// input to w.
