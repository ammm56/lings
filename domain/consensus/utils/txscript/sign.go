...
// SignatureScript creates an input signature script for tx to spend LSN sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend LSN sent
