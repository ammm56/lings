...
func (v *transactionValidator) checkTransactionAmountRanges(tx *externalapi.DomainTransaction) error {
	...
	// as a sompi. One lings is a quantity of sompi as defined by the
	// sompiPerLings constant.
	...
	for _, txOut := range tx.Outputs {
		...
		// This is impossible for Lings, but perhaps possible if an alt increases
