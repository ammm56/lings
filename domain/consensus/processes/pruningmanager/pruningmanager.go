...
import (
	...
	"github.com/ammm56/lings/domain/consensus/utils/virtual"
...
// This is a sanity test, to make sure that lings doesn't store, and subsequently sends syncing peers the wrong UTXOSet.
