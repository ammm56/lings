...
GetCurrentNetworkRequestMessage requests the network lings is currently running against.
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| payAddress | [string](#string) |  | Which lings address should the coinbase block reward transaction pay into |
...
| ----- | ---- | ----- | ----------- |
| block | [RpcBlock](#protowire.RpcBlock) |  |  |
| isSynced | [bool](#bool) |  | Whether lings thinks that it&#39;s synced. Callers are discouraged (but not forbidden) from solving blocks when lings is not synced. That is because when lings isn&#39;t in sync with the rest of the network there&#39;s a high chance the block will never be accepted, thus the solving effort would have been wasted. |
| error | [RPCError](#protowire.RPCError) |  |  |
...
GetPeerAddressesRequestMessage requests the list of known lings addresses in the
...
currently connected to this lings.
...
| isOutbound | [bool](#bool) |  | Whether this lings initiated the connection |
| timeOffset | [int64](#int64) |  |  |
| userAgent | [string](#string) |  |  |
| advertisedProtocolVersion | [uint32](#uint32) |  | The protocol version that this peer claims to support |
| timeConnected | [int64](#int64) |  | The timestamp of when this peer connected to this lings |
...
AddPeerRequestMessage adds a peer to lings&#39;s outgoing connection list.
This will, in most cases, result in lings connecting to said peer.
...
parent chain from some startHash to this lings&#39;s current virtual
...
GetBlockCountRequestMessage requests the current number of blocks in this lings.
...
ShutDownRequestMessage shuts down this lings.
...
This call is only available when this lings was started with `--utxoindex`
...
GetUtxosByAddressesRequestMessage requests all current UTXOs for the given lings addresses
