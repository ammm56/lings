...
func (x *LingsMessage_RequestHeaders) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *LingsMessage_RequestHeaders) fromAppMessage(msgRequestHeaders *appmessage.MsgRequestHeaders) error {
