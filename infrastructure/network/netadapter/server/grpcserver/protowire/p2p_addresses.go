...
func (x *LingsMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "LingsMessage_Addresses is nil")
	}
...
func (x *LingsMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
