...
type P2P_MessageStreamClient interface {
	Send(*LingsMessage) error
	Recv() (*LingsMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *LingsMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*LingsMessage, error) {
	m := new(LingsMessage)
...
func (x *p2PMessageStreamServer) Send(m *LingsMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*LingsMessage, error) {
	m := new(LingsMessage)
...
func (x *rPCMessageStreamClient) Send(m *LingsMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*LingsMessage, error) {
	m := new(LingsMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *LingsMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*LingsMessage, error) {
	m := new(LingsMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
