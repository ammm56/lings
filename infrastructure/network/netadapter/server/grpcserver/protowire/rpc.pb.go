...
type GetBlockTemplateRequestMessage struct {
	...
	// Which lings address should the coinbase block reward transaction pay into
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether lings thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when lings is not synced.
	// That is because when lings isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this lings initiated the connection
	...
	// The timestamp of when this peer connected to this lings
