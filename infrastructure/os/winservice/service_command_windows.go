...
// installService attempts to install the lings service. Typically this should
...
// removeService attempts to uninstall the lings service. Typically this should
...
// startService attempts to Start the lings service.
