...
import (
	...
	"github.com/ammm56/lings/cmd/lingswallet/liblingswallet/bip32"
...
func create(conf *createConfig) error {
	...
	fmt.Printf("Notice the above is neither a secret key to your wallet " +
		"(use \"lingswallet dump-unencrypted-data\" to see a secret seed phrase) " +
		"nor a wallet public address (use \"lingswallet new-address\" to create and see one)\n\n")
	...
	if len(signerExtendedPublicKeys) > 0 {
		cosignerIndex, err = liblingswallet.MinimumCosignerIndex(signerExtendedPublicKeys, extendedPublicKeys)
		if err != nil {
			return err
		}
	}
